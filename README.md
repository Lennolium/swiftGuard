...
- **Whitelisting:** Allows users to whitelist authorized devices, ensuring
  hassle-free connectivity.
- **Discrete:** Operates in the macOS system tray, minimizing
  interruptions.
- **Customizable:** Allows users to configure various settings, including
  action (shutdown/hibernate), countdown timer and whitelist.
- **Lightweight:** Designed to consume minimal system resources for optimal
  performance.
- **Privacy:** Does not require an internet connection, ensuring the privacy
  of your data.
- **Open Source:** Provides transparency and
...
- **Anti-Forensic Measures:** In case the police or other thugs break in. The police often use a [mouse jiggler](https://en.wikipedia.org/wiki/Mouse_jiggler)
...
- **Public Environments:** If you frequently use your Mac in public places like libraries or cafes, swiftGuard
...
- **Data Protection Regulations:** Many industries and organizations are subject to strict data protection
...
> **Note:** If you get a warning that the application is from an _unidentified developer_, you have to open
...
- **Feature Request:** Make this project better by [submitting a feature request](https://github.com/Lennolium/swiftGuard/discussions/2).
- **Documentation:** Improve our documentation by [adding a wiki page](https://github.com/Lennolium/swiftGuard/wiki).
- **Community Support:** Help others on [GitHub Discussions](https://github.com/Lennolium/swiftGuard/discussions).
- **Security Report:** Report critical security issues via our [template](https://github.com/Lennolium/swiftGuard/blob/main/.github/SECURITY.md).
